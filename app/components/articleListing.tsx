...
const ArticleListing = (article: IMediumArticle) => {
  const { title, pubDate, link, guid, author, thumbnail, description } =
    article;
  return (
    <li className='mb-12'>
      <div className='group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50'>
        ...
        >
          {/* <Image src={thumbnail} alt='article image' width='150' height='150' /> */}
          {pubDate.split(' ')[0]}
        </header>
